    ...
    let p1r=0, p1g=0, p1b=0, p1button = document.getElementById('p1_color_button');
    let p2r=0, p2g=0, p2b=0, p2button = document.getElementById('p2_color_button');
    let image, ctx;
    ...
    function draw_playfield() {
      ...
      if (elapsed > fpsInterval) {
          ...
          if(int_x == Math.floor(x) && int_y == Math.floor(y)) {
            ...
            if (image.data[400*4*int_y + int_x*4] == 0)
            { 
          ...
          if(int_x2 == Math.floor(x2) && int_y2 == Math.floor(y2)) {
            ...
            if (image.data[400*4*int_y2 + int_x2*4] == 0)
            { 
